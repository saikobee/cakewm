...
class Binds(object):
    ...
    move_win_tag_1    = screen_do(lambda x: x.move_win_tag_num(1))
    move_win_tag_2    = screen_do(lambda x: x.move_win_tag_num(2))
    move_win_tag_3    = screen_do(lambda x: x.move_win_tag_num(3))
    move_win_tag_4    = screen_do(lambda x: x.move_win_tag_num(4))
    move_win_tag_5    = screen_do(lambda x: x.move_win_tag_num(5))
    move_win_tag_6    = screen_do(lambda x: x.move_win_tag_num(6))
    move_win_tag_7    = screen_do(lambda x: x.move_win_tag_num(7))
    move_win_tag_8    = screen_do(lambda x: x.move_win_tag_num(8))
    move_win_tag_9    = screen_do(lambda x: x.move_win_tag_num(9))
    select_tag_next   = screen_do(lambda x: x.select_tag_next())
    select_tag_prev   = screen_do(lambda x: x.select_tag_prev())
    select_tag_1      = screen_do(lambda x: x.select_tag_num(1))
    select_tag_2      = screen_do(lambda x: x.select_tag_num(2))
    select_tag_3      = screen_do(lambda x: x.select_tag_num(3))
    select_tag_4      = screen_do(lambda x: x.select_tag_num(4))
    select_tag_5      = screen_do(lambda x: x.select_tag_num(5))
    select_tag_6      = screen_do(lambda x: x.select_tag_num(6))
    select_tag_7      = screen_do(lambda x: x.select_tag_num(7))
    select_tag_8      = screen_do(lambda x: x.select_tag_num(8))
    select_tag_9      = screen_do(lambda x: x.select_tag_num(9))
